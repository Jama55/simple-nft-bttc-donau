...
const web3Modal = new Web3Modal({
  network: "bttc_donau", // Optional. If using WalletConnect on xDai, change network to "xdai" and add RPC info below for xDai chain.
    ...
    walletconnect: {
      ...
      options: {
        ...
        rpc: {
          ...
          1029: "https://pre-rpc.bt.io/", //bttc donau testnet
        },
      },
